...
class _MyAppState extends State<MyApp> {
  ...
  children: [
    ...
    for (var index = 0; index < positions.length; index++)
      Positioned(
        bottom: mediaSize.height * (positions[index]['bottom'] ?? 0),
        ...
        child: Stack(
          children: [
                ...
                : IconButton(
                    onPressed: () async {
                      if (await checkWhichPopUp(index)) {
                        gridInfoAfterInsert(context, index, shownDate);
                      } else {
                        positioninfos(context, index, shownDate);
                      }
                    },
                    icon: const Icon(Icons.fiber_manual_record),
                    color: _isButtonFree[index] ? Colors.red : Colors.green,
                    splashColor: Colors.transparent,
                    highlightColor: Colors.transparent,
                    hoverColor: Colors.transparent,
                    key: ValueKey(index),
            ...
            if (positions[index]['electricityConnection'] == true)
              Positioned(
                bottom: 0, // Adjust the position of the yellow circle as needed
                child: Container(
                  width: 35.0, // Adjust the size of the container as needed
                  height: 35.0, // Adjust the size of the container as needed
                  ...
                  child: Icon(
                    Icons.bolt,
                    color: Colors.black,
                    size: 20.0, // Adjust the size of the bolt icon as needed
                  ),
                ),
              ),
          ],
